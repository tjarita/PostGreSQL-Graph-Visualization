...
(Country1 VARCHAR(4) REFERENCES Country DEFERRABLE INITIALLY DEFERRED,
 Country2 VARCHAR(4) REFERENCES Country DEFERRABLE INITIALLY DEFERRED,
 Length NUMERIC
   CHECK (Length > 0),
 CONSTRAINT BorderKey PRIMARY KEY (Country1,Country2) );

CREATE TABLE encompasses
(Country VARCHAR(4) NOT NULL REFERENCES Country DEFERRABLE INITIALLY DEFERRED,
 Continent VARCHAR(20) NOT NULL REFERENCES Continent DEFERRABLE INITIALLY DEFERRED,
 Percentage NUMERIC,
   CHECK ((Percentage > 0) AND (Percentage <= 100)),
...
(Country VARCHAR(4) REFERENCES Country DEFERRABLE INITIALLY DEFERRED,
 Organization VARCHAR(12) REFERENCES Organization DEFERRABLE INITIALLY DEFERRED,
...
ALTER TABLE Lake
  ADD CONSTRAINT River_FKey FOREIGN KEY (River) REFERENCES River(Name) DEFERRABLE INITIALLY DEFERRED;

CREATE TABLE geo_Mountain
(Mountain VARCHAR(35) REFERENCES Mountain DEFERRABLE INITIALLY DEFERRED,
 Country VARCHAR(4) ,
 Province VARCHAR(35) ,
...
(Desert VARCHAR(35) REFERENCES Desert DEFERRABLE INITIALLY DEFERRED,
 Country VARCHAR(4) ,
 Province VARCHAR(35) ,
...
(Sea1 VARCHAR(35) REFERENCES Sea DEFERRABLE INITIALLY DEFERRED,
 Sea2 VARCHAR(35) REFERENCES Sea DEFERRABLE INITIALLY DEFERRED,
